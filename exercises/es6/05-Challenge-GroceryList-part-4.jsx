...
//
// Extra Task: As you can see in the `GroceryList` component - it has more than one TODO
...
//
// Extra Task: Extract creation (`addGroceryItem`) of grocery to external service. TODO
...
class GroceryList extends React.Component {
  ...
  render() {
    ...
    newProductAddButton = <button className='add-product' onClick={this.addGroceryItem} disabled={this.state.newGroceryName.length == 0}>Add new Product</button>;
